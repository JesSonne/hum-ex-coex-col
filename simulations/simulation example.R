...
path="..Downloads/doi_10.5061_dryad.rr4xgxd7n__v3"

# set working directory to the github folder
setwd("...Downloads/hum-ex-coex-col-main") 

#overview of central American networks
C_Am_nets=subset(dat,dat$Ecoregion=="North America")[-(1:2),]
...
ex=res_with_rewireing[[1]] #proportion of climate-driven extinctions
ex_and_coex=res_with_rewireing[[2]] # proportion of climate-driven extinctions + coextinctions
